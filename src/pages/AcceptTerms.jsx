  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding:'40px 48px', width:'100%', maxWidth:480,
        boxShadow:'var(--shadow-lg)', border:'1px solid var(--border)',
      }}>
        <div style={{ fontFamily:'var(--font-display)', fontSize:26,
          fontWeight:400, marginBottom:24, color:'var(--ink)', textAlign:'center' }}>
          reviewz<span style={{ color:'#1D9E75' }}>health</span>
        </div>

        <h1 style={{ fontSize:20, fontWeight:500, color:'var(--ink)',
